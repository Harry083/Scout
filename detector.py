...
folded into the handful of categories an investigator actually sorts footage by:
...
STOCK_MODELS = {"n": "yolo26n.pt", "s": "yolo26s.pt", "m": "yolo26m.pt"}
...
def resolve_model(model: str) -> str:
    """A stock size ("n"/"s"/"m") -> weights file in models/.
